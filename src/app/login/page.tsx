...
export default function LoginPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Consultas em tempo real"
    },
    {
      icon: Users,
      title: "Suporte 24/7",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="grid min-h-screen lg:grid-cols-2">
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Faça login para acessar sua conta e realizar consultas
              </p>
            </div>
        ...
        {/* Branding Section */}
        <div className="hidden lg:flex lg:flex-col lg:justify-center lg:items-center bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10 text-center text-white px-8 max-w-lg">
            ...
            <div className="flex items-center justify-center mb-8">
              <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-white/20 backdrop-blur-sm border border-white/30">
            ...
            <p className="text-xl text-blue-100 mb-8">
              A plataforma de consultas mais confiável do Brasil
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-sm text-blue-200">Consultas</div>
              </div>
              <div className="text-center">
